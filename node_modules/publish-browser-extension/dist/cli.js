...
var require_jwa = __commonJS({
  "node_modules/.pnpm/jwa@1.4.1/node_modules/jwa/index.js"(exports, module) {
    "use strict";
...
var require_decode = __commonJS({
  "node_modules/.pnpm/jsonwebtoken@8.5.1/node_modules/jsonwebtoken/decode.js"(exports, module) {
    "use strict";
    var jws = require_jws();
...
var require_JsonWebTokenError = __commonJS({
  "node_modules/.pnpm/jsonwebtoken@8.5.1/node_modules/jsonwebtoken/lib/JsonWebTokenError.js"(exports, module) {
    "use strict";
...
var require_NotBeforeError = __commonJS({
  "node_modules/.pnpm/jsonwebtoken@8.5.1/node_modules/jsonwebtoken/lib/NotBeforeError.js"(exports, module) {
    "use strict";
...
var require_TokenExpiredError = __commonJS({
  "node_modules/.pnpm/jsonwebtoken@8.5.1/node_modules/jsonwebtoken/lib/TokenExpiredError.js"(exports, module) {
    "use strict";
    var JsonWebTokenError = require_JsonWebTokenError();
...
var require_timespan = __commonJS({
  "node_modules/.pnpm/jsonwebtoken@8.5.1/node_modules/jsonwebtoken/lib/timespan.js"(exports, module) {
    "use strict";
    var ms = require_ms();
...
var require_semver = __commonJS({
  "node_modules/.pnpm/semver@5.7.1/node_modules/semver/semver.js"(exports, module) {
    "use strict";
...
var require_psSupported = __commonJS({
  "node_modules/.pnpm/jsonwebtoken@8.5.1/node_modules/jsonwebtoken/lib/psSupported.js"(exports, module) {
    "use strict";
...
var require_verify = __commonJS({
  "node_modules/.pnpm/jsonwebtoken@8.5.1/node_modules/jsonwebtoken/verify.js"(exports, module) {
    "use strict";
    var JsonWebTokenError = require_JsonWebTokenError();
...
var require_sign = __commonJS({
  "node_modules/.pnpm/jsonwebtoken@8.5.1/node_modules/jsonwebtoken/sign.js"(exports, module) {
    "use strict";
    var timespan = require_timespan();
    var PS_SUPPORTED = require_psSupported();
    var jws = require_jws();
...
var require_jsonwebtoken = __commonJS({
  "node_modules/.pnpm/jsonwebtoken@8.5.1/node_modules/jsonwebtoken/index.js"(exports, module) {
    "use strict";
    module.exports = {
...
// src/chrome/chrome-web-store.ts
var ChromeWebStoreOptions = z.object({
  zip: z.string().min(1),
...
var EdgeApi = class {
  ...
  async uploadDraft(params) {
    ...
    const file = fs2.createReadStream(params.zipFile);
...
var EdgeAddonStoreOptions = z2.object({
  zip: z2.string().min(1),
  productId: z2.string().min(1),
  clientId: z2.string().min(1),
  clientSecret: z2.string().min(1),
  accessTokenUrl: z2.string().min(1),
  skipSubmitReview: z2.boolean().default(false)
});
...
import { fileFromPath as fileFromPath2 } from "formdata-node/file-from-path";
var AddonsApi = class {
  constructor(options) {
    this.options = options;
  }
  ...
  async uploadCreate(params) {
    ...
    form.append("upload", await fileFromPath2(params.file));
  ...
  async versionCreate(params) {
    ...
    if (params.sourceFile) {
      form.append("source", await fileFromPath2(params.sourceFile));
    } else {
      form.append("source", "");
    }
    return await fetch(endpoint.href, {
...
var FirefoxAddonStoreOptions = z3.object({
  zip: z3.string().min(1),
  sourcesZip: z3.string().min(1).optional(),
  extensionId: z3.string().min(1),
  jwtIssuer: z3.string().min(1),
  jwtSecret: z3.string().min(1),
  channel: z3.enum(["listed", "unlisted"]).default("listed")
});
...
async function init(config2) {
  consola2.info(`Initialize or update an existing \`${envFile}\` file.`);
...
async function initChrome(previousOptions) {
  const entries = [];
  console.log();
  consola2.start("Chrome Web Store\n");
  consola2.log("`--chrome-extension-id` can be found:");
  consola2.log("  1. Under the extension name in the CWS developer console");
  consola2.log("  2. In the URL of the CWS page for the item");
  consola2.log("Example: `ocfdgncpifmegplaglcnglhioflaimkd`");
  ...
  if (generateRefreshToken) {
    ...
    consola2.log(authCodeUrl);
    const authCode = await consola2.prompt(
    ...
    consola2.info(`Refresh token: \`${refreshToken}\``);
...
async function initFirefox(previousOptions) {
  const entries = [];
  console.log();
  consola2.start("Firefox Addon Store\n");
  consola2.info(
...
async function initEdge(previousOptions) {
  const entries = [];
  console.log();
  consola2.start("Edge Addon Store\n");
  consola2.info(
...
async function updateEnvFile(entries) {
  consola2.start(`Writing to \`${envFile}\`...`);
...
${replacement}`;
  ...
  await copyFile(envFile, backupFilename).then(() => {
    consola2.info(`Backed up old \`${envFile}\` to \`${backupFilename}\``);
  }).catch(() => {
  });
  await writeFile(envFile, template, "utf-8");
  console.log();
  consola2.success("Wrote config to `.env.submit`");
}
