import { Browser, Alarms, Notifications, Runtime, Storage, Tabs, WebNavigation, Windows } from 'webextension-polyfill';
...
interface BrowserOverrides {
    ...
    tabs: Pick<Tabs.Static, 'get' | 'getCurrent' | 'create' | 'duplicate' | 'query' | 'highlight' | 'remove'> & {
        resetState(): void;
    ...
    windows: Pick<Windows.Static, 'get' | 'getAll' | 'create' | 'getCurrent' | 'getLastFocused' | 'remove' | 'update'> & {
        resetState(): void;
...
export { FakeBrowser, fakeBrowser };
